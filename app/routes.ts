...
export default [
  ...
  route("lovable", "routes/lovable.tsx"),
  route("admin", "routes/admin.tsx"),
  route("canal+", "routes/canal.tsx"),
  ...
  route("api/canal", "routes/api.canal.ts"),
  route("api/claude", "routes/api.claude.ts"),
  route("api/scribd", "routes/api.scribd.ts"),
  route("api/lovable", "routes/api.lovable.ts"),
  ...
  route("api/admin/files", "routes/api-admin-files.ts"),
